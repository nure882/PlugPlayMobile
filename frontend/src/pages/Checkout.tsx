        ...
        <div className="lg:col-span-2 space-y-6">
          <section className="bg-white rounded-lg p-6 border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input placeholder="First Name" className="p-3 rounded-lg bg-gray-100" />
              <input placeholder="Last Name" className="p-3 rounded-lg bg-gray-100" />
              <input placeholder="Email" className="p-3 rounded-lg bg-gray-100 md:col-span-2" />
              <input placeholder="Phone Number" className="p-3 rounded-lg bg-gray-100 md:col-span-2" />
              <input placeholder="City" className="p-3 rounded-lg bg-gray-100" />
              <input placeholder="Street" className="p-3 rounded-lg bg-gray-100" />
              <input placeholder="House" className="p-3 rounded-lg bg-gray-100" />
              <input placeholder="Apartment (optional)" className="p-3 rounded-lg bg-gray-100" />
            </div>
          </section>
